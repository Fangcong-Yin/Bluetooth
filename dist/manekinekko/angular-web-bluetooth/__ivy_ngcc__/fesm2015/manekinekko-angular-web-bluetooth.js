...
BrowserWebBluetooth.ɵfac = function BrowserWebBluetooth_Factory(t) { return new (t || BrowserWebBluetooth)(); };
BrowserWebBluetooth.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: BrowserWebBluetooth, factory: BrowserWebBluetooth.ɵfac });
/** @nocollapse */
BrowserWebBluetooth.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BrowserWebBluetooth, [{
        type: Injectable
...
ServerWebBluetooth.ɵfac = function ServerWebBluetooth_Factory(t) { return new (t || ServerWebBluetooth)(); };
ServerWebBluetooth.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: ServerWebBluetooth, factory: ServerWebBluetooth.ɵfac });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ServerWebBluetooth, [{
        type: Injectable
    }], null, null); })();
...
ConsoleLoggerService.ɵfac = function ConsoleLoggerService_Factory(t) { return new (t || ConsoleLoggerService)(); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ConsoleLoggerService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
NoLoggerService.ɵfac = function NoLoggerService_Factory(t) { return new (t || NoLoggerService)(); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(NoLoggerService, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
...
BluetoothCore.ɵfac = function BluetoothCore_Factory(t) { return new (t || BluetoothCore)(ɵngcc0.ɵɵinject(BrowserWebBluetooth), ɵngcc0.ɵɵinject(ConsoleLoggerService)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(BluetoothCore, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: BrowserWebBluetooth }, { type: ConsoleLoggerService }]; }, null); })();
...
WebBluetoothModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: WebBluetoothModule });
WebBluetoothModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function WebBluetoothModule_Factory(t) { return new (t || WebBluetoothModule)(); }, imports: [[CommonModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(WebBluetoothModule, { imports: function () { return [CommonModule]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(WebBluetoothModule, [{
        type: NgModule,
        args: [{
